...
export class VmTuidMain extends VmTuid {
    constructor() {
        ...
        this.onSearch = (key) => __awaiter(this, void 0, void 0, function* () { }); //await this.navVm(VmTuidList, key);
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (owner === undefined) {
                ...
                for (let i in this.proxies) {
                    let link; // = this.vmUsq.vmLinkFromName('tuid', i);
...
const ProxyMainPage = ({vm}:{vm:VmTuidMain}) => {
    let {label, vmUsq, entity, entityClick, entityRender, proxies} = vm;
    let arr:string[] = [];
    ...
    return <Page header={label}>
        <List className="my-2"
            ...
            items={arr.map(v => vmUsq.vmLinkFromName('tuid', v))}
