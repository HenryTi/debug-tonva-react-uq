...
export class VmForm extends ViewModel {
    ...
    init({ fields, arrs, ui, readOnly, vmUsq }) {
        this.fields = fields;
        this.arrs = arrs;
    ...
    buildControl(fieldUI, formValues) {
        ...
        let tuid = this.vmUsq.getTuid(tuidName);
        let pickerConfig = {
            picker: undefined,
            row: undefined,
        };
        return new VmTuidControl(fieldUI, formValues, this.vmUsq, tuid, JSONContent, pickerConfig);
    }
