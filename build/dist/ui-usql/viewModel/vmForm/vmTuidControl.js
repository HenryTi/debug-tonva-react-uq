...
export class VmTuidControl extends VmControl {
    constructor(fieldUI, formValues, vmUsq, tuid, tuidContent, pickerConfig) {
        super(fieldUI, formValues);
        this.onClick = () => __awaiter(this, void 0, void 0, function* () {
            if (this.readOnly === true) {
                let vm = this.vmUsq.newVmTuidView(this.tuid);
            ...
            let vmTuidPicker = new typePicker(this.vmUsq, '搜索 - ' + this.tuid.name, this.tuid, this.onSelected, this.pickerConfig && this.pickerConfig.row);
