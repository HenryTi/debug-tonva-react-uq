...
export class VmTuidControl extends VmControl {
    constructor(fieldUI, formValues, crUsq, tuid, tuidContent, pickerConfig) {
        ...
        this.onClick = () => __awaiter(this, void 0, void 0, function* () {
            ...
            let vmTuidPicker = new typePicker(this.crUsq, '搜索 - ' + this.tuid.name, this.tuid, this.onSelected, this.pickerConfig && this.pickerConfig.row);
