...
export class CUq extends Controller /* implements Usq*/ {
    private ui:any;
    ...
    constructor(cApp:CApp, usq:string, appId:number, usqId:number, access:string, ui:UqUI) {
        ...
        if (usq === '$$$/$unitx') {
            ...
            uqApi = new UqApi(baseUrl, usqOwner, usqName, acc, true);
        }
