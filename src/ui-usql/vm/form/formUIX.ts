...
import { FormUI, FieldBandUI, FieldsBandUI, ArrBandUI, SubmitBandUI, FieldUI,
    TuidFieldUI, InputUI, StringUI, IntUI, DecUI, TextUI, CheckUI, SelectUI, RadioUI, NumberUI } from './formUI';
...
export interface TuidUIX extends TuidFieldUI, FieldUIXBase {
}
