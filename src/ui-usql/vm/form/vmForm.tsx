...
export interface VmFormOptions {
    ...
    ui?: FormUI;
    readOnly?: boolean;
    crUsq?: CrUsq;                  // 主要用于tuid control的生成，也可以没有
}
...
export class VmForm extends ViewModel {
    ...
    init({fields, arrs, ui, readOnly, crUsq}:VmFormOptions) {
        this.fields = fields;
        this.arrs = arrs;
    ...
    protected buildControl(fieldUI: FieldUIX, formValues:FormValues):VmControl {
        ...
        let tuid = this.crUsq.getTuid(tuidName);
        let pickerConfig: PickerConfig = {
            picker: undefined,          // TypeVmTuidPicker;
            row: undefined,             // RowContent
        };
        return new VmTuidControl(fieldUI, formValues, this.crUsq, tuid, JSONContent, pickerConfig)
    }
    ...
    private buildVmArr(arr:ArrFields, arrBandUI:ArrBandUIX): VmArr {
        let ret = new VmArr(this.crUsq, arr, arrBandUI);
