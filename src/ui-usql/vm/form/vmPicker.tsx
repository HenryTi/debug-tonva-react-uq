...
export class VmPicker extends ViewModel {
    ...
    constructor(options: VmPickerOptions) {
        super();
        let {crUsq, pagedItems, caption, onSelected, row} = options;
        this.crUsq = crUsq;
...
export class VmTuidPicker extends VmPicker {
    constructor(crUsq: CrUsq, caption:string, tuid: TuidBase, onSelected:(item:any)=>Promise<void>, row:TypeContent) {
        super({
            crUsq: crUsq,
...
export class VmQueryPicker extends VmPicker {
    constructor(crUsq: CrUsq, caption:string, query:Query, onSelected:(item:any)=>Promise<void>, row:TypeContent) {
        super({
            crUsq: crUsq,
