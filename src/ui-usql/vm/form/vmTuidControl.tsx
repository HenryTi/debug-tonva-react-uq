...
export type TypeVmTuidControl = typeof VmTuidControl; // new (crUsq:CrUsq, tuid: Tuid, vmFormRowTuidInput: VmFormRowTuidInput, tuidContent: TypeContent) => VmTuidInput;
